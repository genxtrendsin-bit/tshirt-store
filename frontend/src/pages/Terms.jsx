  ...
  return (
    <div className="legal-page">
      ...
      <div className="legal-hero">
        ...
        <p>Welcome to <span>BARATEES</span></p>
      </div>
      ...
      <div className="legal-container">
        ...
        <div className="legal-card">
          ...
          <p>
            By accessing BARATEES, you agree to use our services for lawful
        ...
        <div className="legal-card">
          ...
          <p>
            BARATEES is not liable for indirect or incidental damages arising
